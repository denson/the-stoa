...
If your context compacts: re-read this brief from `git show beadwork:attachments/stoa--x5t/HUMAN_paste-polybius_the-stoa-x5t-instruction.md`, re-read `substrate/arcs/arc-74-build-directive.md`, and direct-read `bw show stoa--x5t` for live arc state (a Monitor does not survive a compaction).
