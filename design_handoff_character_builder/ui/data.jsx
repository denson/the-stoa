// Sample data lifted from agent-character-builder/data-samples/
window.STOA_DATA = {
  officers: [
    ...
    { name: "NESTOR", rank: "captain", archetype: "orchestrator", nickname: "Nestor",
      ...
      lieutenants: ["dispatch-lieutenant","format-validate"], reading: ["envelope-lifecycle","inter-agent-comms"], tier: "opus" },
    { name: "CAPTAIN_PLINY", rank: "captain", archetype: "orchestrator", nickname: "Pliny",
      ...
      tools: ["Read","Write","Edit","Grep","TodoWrite"], lieutenants: [], reading: ["envelope-lifecycle"], tier: "opus" },
    { name: "DAEDALUS", rank: "captain", archetype: "architect", nickname: "Daedalus",
      ...
      lieutenants: ["runner","format-validate","scout"], reading: ["envelope-lifecycle","inter-agent-comms"], tier: "opus" },
    { name: "ARGUS", rank: "captain", archetype: "plan-critic", nickname: "Argus",
      ...
      tools: ["Read","Grep","Glob","TodoWrite"], lieutenants: ["runner"], reading: ["envelope-lifecycle"], tier: "opus" },
    { name: "STRABO", rank: "captain", archetype: "researcher", nickname: "Strabo",
      ...
      tools: ["Read","WebSearch","WebFetch","Write","TodoWrite"], lieutenants: [], reading: ["envelope-lifecycle"], tier: "opus" },
    { name: "ADA", rank: "captain", archetype: "executor", nickname: "Ada",
      ...
      tools: ["Bash","Read","Write","Edit","Grep","Glob","TodoWrite"], lieutenants: ["runner","format-validate"], reading: ["envelope-lifecycle","fix-now-discipline"], tier: "opus" },
    { name: "VERA", rank: "captain", archetype: "verifier", nickname: "Vera",
      ...
      tools: ["Bash","Read","Write","Edit","Grep","Glob","TodoWrite","WebSearch","WebFetch"],
      lieutenants: ["runner","format-validate"], reading: ["envelope-lifecycle"], tier: "opus" },
    { name: "CATO", rank: "captain", archetype: "reviewer", nickname: "Cato",
      role: "Reviewer; audits diffs for craft, safety, and regressions.",
      tools: ["Read","Grep","Glob","TodoWrite"], lieutenants: [], reading: ["envelope-lifecycle"], tier: "opus" },
    { name: "CURATOR", rank: "captain", archetype: "curator", nickname: "Curator",
      ...
      tools: ["Read","Write","Grep","Glob","TodoWrite"], lieutenants: [], reading: ["envelope-lifecycle"], tier: "opus" },
    { name: "HERALD", rank: "lieutenant", archetype: "intake", nickname: "Herald",
      ...
      tools: ["Bash","Read","Write","Grep","Glob","TodoWrite"], lieutenants: [], reading: [], tier: "opus" },
    { name: "SCOUT", rank: "lieutenant", archetype: "scout", nickname: "Scout",
      ...
      tools: ["Bash","Read","Grep","Glob","TodoWrite"], lieutenants: [], reading: [], tier: "opus" },
  ],
  skills: [
  ...
  archetypes: {
    orchestrator: "#5B4D86", architect: "#2E6E63", verifier: "#785637",
    executor: "#4A6E2E", reviewer: "#6E2E4A", "plan-critic": "#6E4A2E",
    researcher: "#2E4A6E", curator: "#4A2E6E", intake: "#6E6E2E", scout: "#2E6E4A",
  },
