# Arc 28 design REV3 — bw 0.13.0 substrate adoption (B.3 + B.4) + bw-upgrade discipline (C.1 + C.2)
...
**Supersedes:** `design.md` (rev1) per the ARGUS rev1 verdict at `stoa--s6n` 2026-05-17T03:07:43Z, and `design-rev2.md` per the ARGUS rev2 verdict at `stoa--s6n` 2026-05-17T03:12:56Z. Rev1 and rev2 both stay on disk as history per substrate convention.
...
4. **LBR-1 defang smoke (added rev2; mechanism revised rev3 per ARGUS rev2 NEW-1):**
   ```bash
