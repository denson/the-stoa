...
| `substrate/skills/check-substrate-updates/SKILL.md` (YAML frontmatter) | Insert `author: Denson Smith` after `description:` line | **Fix-now per CLAUDE.md global + op-disc §4.8** — same rationale as agent-author. Cost = 1 line. After this arc, 6 of 6 substrate skills carry `author: Denson Smith` frontmatter (was 4 of 6 pre-Arc-39). |
