...
- **`{{ROLE_FILE_PATH}}`** is `.claude/MAJOR_PLINY.md` after install at project-tier, or `~/.claude/MAJOR_PLINY.md` at user-tier. The orchestrator reads this file as its first action; getting the path wrong means the role doesn't load.
